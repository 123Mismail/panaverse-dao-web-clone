    ...
    {/* left side */}
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0  ">
        ...
        <div className='grid grid-cols-2 lg:w-[600px] md:w-[500px] w-auto py-10  '>
            <div  className='py-5 flex space-x-2 items-center'>    <input type="checkbox" defaultChecked className="checkbox checkbox-primary " />
              <h3 className='text-black text-[21px] font-medium'>Product Ownership</h3>
            </div>
            <div className='py-5 flex space-x-2 items-center'>
            <input type="checkbox" defaultChecked className="checkbox  " />
              <h3 className='text-black text-[21px] font-medium'>Freelancing</h3>
            </div>
            <div  className='py-5 flex space-x-2 items-center'>
            <input type="checkbox" defaultChecked className="checkbox checkbox-primary" />
              <h3 className='text-black text-[21px] font-medium'>Global marketing by DAO</h3>
            </div>
            <div className='py-5 flex space-x-2 items-center '>
            <input type="checkbox" defaultChecked className="checkbox checkbox-primary" />
              <h3 className='text-black text-[21px] font-medium'>Boosting Economy</h3>
            </div>
        </div>
